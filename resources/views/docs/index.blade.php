...
@section('content')
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <!-- Quick Actions -->
            <div class="mt-16 bg-indigo-700 dark:bg-indigo-900 rounded-lg shadow-xl overflow-hidden">
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-8 flex justify-center space-x-4">
                            <a href="{{ route('docs.quickstart') }}"
                                class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-white hover:bg-indigo-50 dark:text-indigo-900 dark:bg-white dark:hover:bg-gray-100">
                                Quick Start Guide
                            </a>
                            <a href="{{ route('docs.documentation') }}"
                                class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-600 dark:bg-indigo-600 dark:hover:bg-indigo-700">
                                Full Documentation
                            </a>
                        </div>
                    </div>
