      ...
      "fivem": {
        ...
        <section class="mb-12">
            ...
            <div class="mb-8 border-l-4 border-indigo-500 pl-6">
                ...
                <p class="text-gray-700 mb-4">Search FiveM documentation for specific topics.</p>

                <h4 class="font-semibold text-gray-900 mb-2">Parameters:</h4>
                <ul class="list-disc list-inside text-gray-700 mb-4 ml-4">
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">query</code> (required): Search query (e.g., "events", "natives", "manifest")</li>
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">category</code> (optional): Filter by category (all, scripting, natives, networking, resources)</li>
                </ul>

                <h4 class="font-semibold text-gray-900 mb-2">Example:</h4>
                <pre class="bg-gray-100 rounded p-3 text-sm"><code>Search FiveM docs for "network events"</code></pre>
            </div>
            ...
            <div class="mb-8 border-l-4 border-indigo-500 pl-6">
                ...
                <h4 class="font-semibold text-gray-900 mb-2">Parameters:</h4>
                <ul class="list-disc list-inside text-gray-700 mb-4 ml-4">
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">function_name</code> (required): Native function name (e.g., "GetPlayerPed", "SetEntityCoords")</li>
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">language</code> (optional): Code example language (lua or js)</li>
                </ul>

                <h4 class="font-semibold text-gray-900 mb-2">Common Native Examples:</h4>
                <ul class="list-disc list-inside text-gray-700 mb-4 ml-4">
                    <li>Common natives: <code class="bg-gray-100 px-2 py-1 rounded text-sm">GetPlayerPed</code>, <code class="bg-gray-100 px-2 py-1 rounded text-sm">SetEntityCoords</code>, <code class="bg-gray-100 px-2 py-1 rounded text-sm">GetEntityCoords</code></li>
                    <li>CFX natives: <code class="bg-gray-100 px-2 py-1 rounded text-sm">RegisterNetEvent</code>, <code class="bg-gray-100 px-2 py-1 rounded text-sm">TriggerServerEvent</code>, <code class="bg-gray-100 px-2 py-1 rounded text-sm">TriggerClientEvent</code></li>
            ...
            <div class="mb-8 border-l-4 border-indigo-500 pl-6">
                ...
                <ul class="list-disc list-inside text-gray-700 mb-4 ml-4">
                    ...
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">version</code> (optional): Version number (default: "1.0.0")</li>
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">script_type</code> (optional): lua or js (default: lua)</li>
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">include_client</code> (optional): Include client scripts (default: true)</li>
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">include_server</code> (optional): Include server scripts (default: true)</li>
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">framework</code> (optional): standalone, esx, or qbcore (default: standalone)</li>
                </ul>

                <h4 class="font-semibold text-gray-900 mb-2">Example:</h4>
                <pre class="bg-gray-100 rounded p-3 text-sm"><code>Generate a manifest for an ESX resource called "my-shop"</code></pre>
            </div>

            <!-- Tool 4: GetEventReference -->
            <div class="mb-8 border-l-4 border-indigo-500 pl-6">
                <h3 class="text-xl font-semibold text-gray-900 mb-3">4. GetEventReference</h3>
                <p class="text-gray-700 mb-4">Get information about FiveM events.</p>

                <h4 class="font-semibold text-gray-900 mb-2">Parameters:</h4>
                <ul class="list-disc list-inside text-gray-700 mb-4 ml-4">
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">event_name</code> (optional): Specific event name to look up</li>
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">event_type</code> (optional): Filter by type (all, core, esx, qbcore)</li>
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">language</code> (optional): Code example language (lua or js)</li>
                </ul>
                ...
                <pre class="bg-gray-100 rounded p-3 text-sm mb-2"><code>Look up the playerConnecting event</code></pre>
            ...
            <div class="mb-8 border-l-4 border-indigo-500 pl-6">
                ...
                <ul class="list-disc list-inside text-gray-700 mb-4 ml-4">
                    ...
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">framework</code> (optional): standalone, esx, or qbcore (default: standalone)</li>
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">script_type</code> (optional): lua or js (default: lua)</li>
                    <li><code class="bg-gray-100 px-2 py-1 rounded text-sm">include_nui</code> (optional): Include NUI files (default: false)</li>
                </ul>

                <h4 class="font-semibold text-gray-900 mb-2">Example:</h4>
                <pre class="bg-gray-100 rounded p-3 text-sm"><code>Generate boilerplate for a QBCore resource with NUI called "admin-panel"</code></pre>
            </div>
        </section>
        ...
        <section class="mb-12">
            ...
            <!-- Resource 3: Framework Comparison -->
            <div class="mb-8 border-l-4 border-green-500 pl-6">
                <h3 class="text-xl font-semibold text-gray-900 mb-3">3. Framework Comparison</h3>
                <p class="text-gray-700 mb-4">Comparison of FiveM frameworks: Standalone, ESX, and QBCore.</p>
                <p class="text-gray-600 text-sm">URI: <code class="bg-gray-100 px-2 py-1 rounded text-sm">fivem://guides/framework-comparison</code></p>
                <p class="text-gray-700 mt-2">Complete comparison with pros/cons, code examples, common functions, and migration guides.</p>
            </div>
        </section>
