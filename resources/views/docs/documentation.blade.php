                ...
                @foreach ($groupedTools as $category => $categoryTools)
                    <div class="mb-8">
                        <h3 class="text-xl font-bold text-gray-800 mb-4 flex items-center">
                            ...
                            {{ $category }} Tools
                            <span class="ml-3 text-sm font-normal text-gray-500">({{ count($categoryTools) }})</span>
                        </h3>
                ...
                <section class="mb-12">
                    ...
                    @forelse ($resources as $index => $resource)
                        <div class="mb-6 border-l-4 border-green-500 pl-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $index + 1 }}. {{ $resource['name'] }}</h3>
                            <p class="text-gray-700">{{ $resource['description'] }}</p>
                        </div>
                    @empty
                        <p class="text-gray-500 italic">No resources configured.</p>
                    @endforelse
                </section>
                ...
                <section class="mb-12">
                    ...
                    @forelse ($prompts as $index => $prompt)
                        <div class="mb-6 border-l-4 border-purple-500 pl-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $index + 1 }}. {{ $prompt['name'] }}</h3>
                            <p class="text-gray-700">{{ $prompt['description'] }}</p>
                        </div>
                    @empty
                        <p class="text-gray-500 italic">No prompts configured.</p>
                    @endforelse
            </section>
